...
import { getAllVeggies } from '../actions/getData';
...
const Veggies = () => {
  ...
  return (
    <div className="p-[2rem]">
      <h1 className="text-xl  font-medium mb-[10px] ">Create Veggie</h1>
